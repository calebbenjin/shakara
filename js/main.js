...
const leftToggleContainer = document.querySelector('.toggle-body .left-container'); 
const rightToggleContainer = document.querySelector('.toggle-body .right-container'); 
